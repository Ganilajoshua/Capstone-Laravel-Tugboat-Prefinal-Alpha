...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 04:13 AM
...
CREATE TABLE `tblbalance` (
  `intBCompanyID` int(11) NOT NULL,
  `fltBalance` float NOT NULL,
...
INSERT INTO `tblbalance` (`intBCompanyID`, `fltBalance`, `dtUpdateBalance`) VALUES
(10, 200, '2018-09-20');
...
(1, NULL, NULL, 'Hi Energy Marine Services INC.', 'Rm. 306 Velco Centre cr Sr. Oca & Delgado Sts., South Harbor, Port Area, Manila', 'hienergymarineservices@gmail.com', '00001', NULL, 0),
(2, NULL, NULL, 'Tugmaster & Barge Pool Inc.', '115 RM 202 J LUNA ST, BINONDO, Manila, Metro Manila,', 'tugmaster@gmail.com', '00002', NULL, 0),
(3, NULL, NULL, 'Black Pink', 'Pandacan, Manila', 'blackpinkyg@gmail.com', '000023', NULL, 0),
(4, NULL, NULL, 'TWICE JYPE', 'Seoul South Korea', 'twicejype@gmail.com', '0000025', NULL, 0),
(5, NULL, NULL, 'TWICE JYPE', 'Seoul South Korea', 'twicesujype@gmail.com', '00000433', NULL, 0),
(6, NULL, NULL, 'Isaac Tailoring Shop', 'Pureza, Manila', 'isaac@gmail.com', '00023145', NULL, 0),
(7, NULL, NULL, 'M Eyenet Training', 'Cubao', 'marinaslevie@gmail.com', '21232', NULL, 0),
(8, NULL, NULL, 'Ganila Tindahan ko', '1985-A Interior 6 Carlos st. Pandacan, Manila', 'ganilajoshua@gmail.com', '232145', NULL, 0),
(9, NULL, NULL, 'Timba Importer Inc.', 'Mexico Cubao', 'Timba@gmail.com', '231467', NULL, 0),
(10, 1, NULL, 'Akari', '115 RM 202 J LUNA ST, BINONDO, Manila, Metro Manila,', 'akari@gmail.com', '23232', NULL, 0);
...
(3, 10, NULL, 'Akari Contract', '<p>AHHHHHHK</p>', NULL, NULL, 'Active', 0, '2018-09-11', '2019-09-11', '1');
...
CREATE TABLE `tbldispatchticket` (
  ...
  `boolCApprovedby` tinyint(1) DEFAULT NULL,
  `boolAApprovedby` tinyint(1) DEFAULT NULL,
  `boolDeleted` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbldispatchticket` (`intDispatchTicketID`, `strDispatchTicketDesc`, `intDTTugboatAssignID`, `boolCApprovedby`, `boolAApprovedby`, `boolDeleted`) VALUES
(1, '1', 1, 1, 1, 0),
(2, '2', 2, 1, 1, 0),
(4, '4', 4, NULL, 1, 0),
(5, '5', 5, 1, 1, 0);
...
CREATE TABLE `tblinvoice` (
  ...
  `enumStatus` enum('Draft','Pending','Paid','Rejected') NOT NULL DEFAULT 'Draft',
...
INSERT INTO `tblinvoice` (`intInvoiceID`, `intIDispatchTicketID`, `intDTCompanyID`, `strInvoiceDesc`, `enumStatus`, `fltBalanceRemain`, `boolDeleted`) VALUES
(10, 5, 10, NULL, 'Pending', NULL, 0),
(12, 1, 10, NULL, 'Pending', NULL, 0),
(13, 2, 10, NULL, 'Draft', NULL, 0);
...
CREATE TABLE `tbljoborder` (
  ...
  `intJOServiceTypeID` int(11) NOT NULL,
...
INSERT INTO `tbljoborder` (`intJobOrderID`, `intJOBerthID`, `strJOStartPoint`, `strJODestination`, `intJOBargeID`, `intJOGoodsID`, `intJOeVesselID`, `intJOCompanyID`, `intJOttachmentsID`, `strJODesc`, `strJOVesselName`, `intJOServiceTypeID`, `dtmETA`, `dtmETD`, `enumStatus`, `fltWeight`, `boolDeleted`) VALUES
(12, 1, 'Pier', 'Pandacan', NULL, 1, NULL, 10, NULL, 'Detail 1', 'Cargo 1', 1, '2018-09-11 03:42:00', '2018-09-13 03:44:23', 'Pending', 10, 0),
(13, 2, 'Pier', 'Pandacan', NULL, 1, NULL, 10, NULL, 'Detail 2', 'Cargo B', 2, '2018-09-10 03:46:00', '2018-09-13 03:46:35', 'Pending', 20, 0),
(14, 6, 'Pier', 'Pandacan', NULL, 1, NULL, 10, NULL, 'Detail 3', 'Cargo 3', 3, '2018-09-02 03:46:00', '2018-09-13 03:47:04', 'Pending', 30, 0),
(15, 6, 'Pier', 'Pandacan', NULL, 2, NULL, 8, NULL, 'Detail 4', 'Cargo 4', 2, '2018-09-09 03:47:00', '2018-09-13 03:47:38', 'Pending', 40, 0),
(16, 6, 'Pier', 'Pandacan', NULL, 4, NULL, 10, NULL, 'Detail 5', 'Cargo 5', 1, '2018-09-10 03:47:00', '2018-09-13 03:48:07', 'Pending', 50, 0);
...
(6, 12, NULL, 1, 0, 'Finished'),
(7, 13, NULL, 2, 0, 'Finished'),
(8, 14, NULL, 3, 0, 'Finished'),
(9, 15, NULL, 4, 0, 'Finished'),
(10, 16, NULL, 5, 0, 'Finished');
...
CREATE TABLE `tblpayment` (
  ...
  `intPInvoiceID` int(11) DEFAULT NULL,
...
(5, NULL, NULL, 3, 0, 100, 100, 100, 200, 300, 2, 100, 0);
...
(1, 'HEMSI', 'hienergymarineservices@gmail.com', '$2y$10$EPf6MLFuhVXXVji1gE.vnONc2PdnoHSEkJ1H8wIPJcLbz2CE6.4de', 1, 'P2GHcGWmfJh4eiNT7LSlFWiNEAXUVhkd4T4cBRisbANgd77nnsI15eObeU8V', '2018-08-26 21:39:55', '2018-08-27 02:50:40', 'Admin', 0, 1, 0),
...
(3, 'Black Pink', 'blackpinkyg@gmail.com', '$2y$10$QeUnO0ypzktouf/19X6k3OEJkQ7iryv2Q24xrv7F1v.ohyQyLoYRW', 3, 'UfbXOQgHrq9bwP5eTxopFugvao3gcNPQsn4Smjgk3Nt7DIYxEtrDgVPxm4ZW', '2018-08-26 22:08:35', '2018-09-05 20:22:43', 'Consignee', 0, 1, 0),
...
(15, 'akari', 'akari@gmail.com', '$2y$10$EPf6MLFuhVXXVji1gE.vnONc2PdnoHSEkJ1H8wIPJcLbz2CE6.4de', 10, 'D3iXZnbTSLRKWFj5l19gkjvnMMJYPRmdOOl4aW2d21yH1oeLCHh1Oahj9QNw', '2018-09-12 11:16:00', '2018-09-12 11:16:49', 'Consignee', 0, 1, 0);
...
ALTER TABLE `tbldispatchticket`
  ...
  ADD KEY `fk_tblDispatchTicket_tblTugboatAssign1_idx` (`intDTTugboatAssignID`);
...
ALTER TABLE `tbljoborder`
  ...
  ADD KEY `fk_tblJobOrder_tblServices` (`intJOServiceTypeID`);
...
ALTER TABLE `tbljobsched`
  ...
  ADD KEY `fk_jobsched_joborder` (`intJSJobOrderID`),
  ADD KEY `fk_jobsched_schedule` (`intJSSchedID`),
  ADD KEY `fk_tbljobsched_tugboatassign` (`intJSTugboatAssignID`);
...
ALTER TABLE `tbllocation`
  ...
  ADD KEY `fk_location_jobsched` (`intLJobSchedID`);
...
ALTER TABLE `tblpayment`
  ...
  ADD KEY `fk_tblPayment_tblCompany1_idx` (`intPInvoiceID`);
...
--
ALTER TABLE `tblbalance`
  MODIFY `intBCompanyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tblberth`
  MODIFY `intBerthID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tblcompany`
--
ALTER TABLE `tblcompany`
  MODIFY `intCompanyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tblcontractlist`
--
ALTER TABLE `tblcontractlist`
  MODIFY `intContractListID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbldispatchticket`
--
ALTER TABLE `tbldispatchticket`
  MODIFY `intDispatchTicketID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tblemployee`
--
ALTER TABLE `tblemployee`
  MODIFY `intEmployeeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tblgoods`
--
ALTER TABLE `tblgoods`
  MODIFY `intGoodsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tblinvoice`
  MODIFY `intInvoiceID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbljoborder`
--
ALTER TABLE `tbljoborder`
  MODIFY `intJobOrderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbljobsched`
--
ALTER TABLE `tbljobsched`
  MODIFY `intJobSchedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbllocation`
--
ALTER TABLE `tbllocation`
  MODIFY `intLocationID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblpier`
  MODIFY `intPierID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tblquotation`
  MODIFY `intQuotationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tblrequest`
--
ALTER TABLE `tblrequest`
  MODIFY `intRequestID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblteam`
  MODIFY `intTeamID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbltugboat`
--
ALTER TABLE `tbltugboat`
  MODIFY `intTugboatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbltugboatassign`
--
ALTER TABLE `tbltugboatassign`
  MODIFY `intTAssignID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbltugboatclass`
--
ALTER TABLE `tbltugboatclass`
  MODIFY `intTugboatClassID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbltugboatinsurance`
  MODIFY `intTugboatInsuranceID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbltugboatmain`
--
ALTER TABLE `tbltugboatmain`
  MODIFY `intTugboatMainID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbltugboatspecs`
--
ALTER TABLE `tbltugboatspecs`
  MODIFY `intTugboatSpecsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbltugboattype`
--
ALTER TABLE `tbltugboattype`
  MODIFY `intTugboatTypeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tblbalance`
  ADD CONSTRAINT `fk_tblbalance_tblcompany` FOREIGN KEY (`intBCompanyID`) REFERENCES `tblcompany` (`intCompanyID`) ON DELETE CASCADE;
...
--
ALTER TABLE `tbljoborder`
  ADD CONSTRAINT `fk_tblJobOrder_tblServices` FOREIGN KEY (`intJOServiceTypeID`) REFERENCES `tblservices` (`intServicesID`),
...
--
ALTER TABLE `tblpayment`
  ADD CONSTRAINT `fk_tblPayment_tblInvoice` FOREIGN KEY (`intPInvoiceID`) REFERENCES `tblinvoice` (`intInvoiceID`) ON UPDATE CASCADE;
...
ALTER TABLE `tblpostbillingticket`
  ...
  ADD CONSTRAINT `fk_tblPostBillingTicket_tblInvoice` FOREIGN KEY (`intPBTInvoiceID`) REFERENCES `tblinvoice` (`intInvoiceID`) ON UPDATE CASCADE,
