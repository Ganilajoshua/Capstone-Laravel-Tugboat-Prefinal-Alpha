...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success : function(data,response){
            ...
            if(currDate == expire){
                toastr.error('You Contract has Expired on &nbsp ' + data.contract[0].datContractExpire, "Contract Status", { positionClass: 'toast-bottom-right', preventDuplicates: true, });
                ...
                toastr.success('Your Contract Will Expire on &nbsp ' + data.contract[0].datContractExpire, "Contract Status", { positionClass: 'toast-bottom-right', preventDuplicates: true, });
            }else{
                console.log('HI');
            }
