...
var skin = function(color) {
	...
	$("head").append($("<link/>", {
		rel: 'stylesheet',
		href: '/others/stisla_admin_v1.0.0/dist/css/skins/' + color + '.css',
		id: 'skin-css'
	}));
}
