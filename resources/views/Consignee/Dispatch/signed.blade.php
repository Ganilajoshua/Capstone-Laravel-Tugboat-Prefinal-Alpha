            ...
            @foreach($dispatch2 as $dispatch2)
                    <tr>
                        ...
                        <td style="width:15%">
                            ...
                            <div class="ml-1 mr-1">
                                <button  onclick="get({{$dispatch2->intDispatchTicketID}})" class="btnView btn btn-sm btn-primary waves-circle waves-effect" data-toggle="tooltip" title="View Details" role="button">
