...
@section('content')
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <ul class="nav nav-pills flex-column" role="tablist">
                                                    ...
                                                    <hr>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="navThirdTab" data-toggle="tab" href="#thirdTab" role="tab" aria-selected="true">Pending Requests</a>
                                                    </li>
                                                    <hr>
                                                    <li class="nav-item">
                                                    ...
                                                    <hr>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="navSixthTab" data-toggle="tab" href="#sixthTab" role="tab" aria-selected="true">Job Order History</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card" id="cardJO">
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    ...
                                                    <!-- Reschedule Job Orders-->
                                                    @include('Consignee.Joborders.reschedulejoborders')
                                                    <!-- Ongoing Job Orders -->
                                                    @include('Consignee.Joborders.ongoingjoborders')                                                
                                                    <!-- Job Order History -->
    ...
    @include('Consignee.Joborders.reschedulemodal')
@endsection
