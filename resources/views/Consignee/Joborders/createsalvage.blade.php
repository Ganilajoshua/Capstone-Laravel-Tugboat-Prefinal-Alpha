    <div class="salvageTab getService" data-servicetype="Salvage">
        <form class="needs-validation" novalidate="">
            ...
            <button id="submitJob" role="button" class="submitJobOrderSalvage btn btn-primary float-right waves-effect" data-service="Salvage">Submit</button>
        </form>
    </div>