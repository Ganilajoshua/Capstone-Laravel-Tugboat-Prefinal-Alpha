            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li id="menudashboardM">
                            <a href="/consignee/dashboard">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                        </li>
                        <li id="/consignee/joborders">
                            <a href="/consignee/joborders">
                                <i class="fas fa-clipboard-list"></i>Job Order</a>
                        </li>
                        <li id="menucontractM">
                    ...
                    <div class="account-item account-item--style2 clearfix js-item-menu">
                        ...
                        <div class="account-dropdown js-dropdown">
                            ...
                            <div class="account-dropdown__footer">
                                <a id="logout" onclick="event.preventDefault(); document.getElementById('logout-form-consignee').submit();" href="/consignee/logout">
