    ...
    {{-- <script type="text/javascript" src="/others/stisla_admin_v1.0.0/dist/js/tugboat.js"></script>
    ...
    <script type="text/javascript" src="/others/stisla_admin_v1.0.0/dist/js/getdata.js"></script>
