                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editBerth" name="editBerth" placeholder="Berth Name" pattern="(Berth)\s*?[0-9]{1,39}" max="45" required>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select id="editPierSelect" name="editPierSelect" class="form-control form-control-lg" required>
