<div class="modal fade" id="requestTeamModal" tabindex="-1" role="dialog" aria-labelledby="forwardModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg" style="max-width: 68%;"role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="forwardModalLabel">Request Team</h5>
                ...
                <div class="modal-body modalBody">
                    <div class="col-12 col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <select id="selectCompany" name="selectCompany" class="form-control form-control-lg wide">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect requestTeam">Request Team</button>
                </div>
            </div>
        </div>
    </div>
