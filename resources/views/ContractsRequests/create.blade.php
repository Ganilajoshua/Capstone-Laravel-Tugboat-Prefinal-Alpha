                        ...
                        <form class="needs-validation" name="form" novalidate="">
                            <div class="card">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select id="contractValidity" name="contractValidity" class="form-control form-control input-lg wide" required>
                                                    <option data-display="" value="" disabled="disabled" selected="selected">Select Contract Validity</option>
                                                    <option data-display="" value="6">6 Months</option>
                                                    <option data-display="" value="1">1 year</option>
                                                </select>
                                                <div class="invalid-feedback">
                                                    Choose contract Validity
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDelayFee">
                                                        ...
                                                        <input type="number" name="addHStandardRate" id="addHStandardRate" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                           Field is empty
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDelayFee">
                                                        ...
                                                        <input type="number" name="addHDelayFee" id="addHDelayFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpViolationFee">
                                                        ...
                                                        <input type="number" name="addHViolationFee" id="addHViolationFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group helpLateFee">
                                                        ...
                                                        <input type="number" name="addHLateFee" id="addHLateFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDamageFee">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" id="minHDamageFee" class="form-control" placeholder="Minimum" required>
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" id="">&amp;</span>
                                                            </div>
                                                            <input type="number" id="maxHDamageFee" class="form-control" placeholder="Maximum" required>
                                                            <div class="invalid-feedback">
                                                                Field is empty
                                                             </div>
                                                        </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDelayFee">
                                                        ...
                                                        <input type="number" name="addTAStandardRate" id="addTAStandardRate" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDelayFee">
                                                        ...
                                                        <input type="number" name="addTADelayFee" id="addTADelayFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpViolationFee">
                                                        ...
                                                        <input type="number" name="addTAViolationFee" id="addTAViolationFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group helpLateFee">
                                                        ...
                                                        <input type="number" name="addTALateFee" id="addTALateFee" class="form-control" required>
                                                        <div class="invalid-feedback">
                                                            Field is empty
                                                         </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group helpDamageFee">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" id="minTADamageFee" class="form-control" placeholder="Minimum" required>
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" id="">&amp;</span>
                                                            </div>
                                                            <input type="number" id="maxTADamageFee" class="form-control" placeholder="Maximum" required>
                                                            <div class="invalid-feedback">
                                                                Field is empty
                                                             </div>
                                                        </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="float-right btn btn-primary waves-effect">Save</button>
                                    {{-- <button onclick="storeContracts()" type="submit" class="float-right btn btn-primary waves-effect">Save</button> --}}
                                </div>
                            </div>
                        </form>
                    </div>
